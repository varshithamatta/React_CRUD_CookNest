...
const CategoriesForm = () => {
  ...
  const handleAddCategory = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${BASE_URL}/api/categories`, { name: newCategory });
  ...
  const handleUpdateCategory = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`${BASE_URL}/api/categories/${editCategoryId}`, { name: editCategoryName });
